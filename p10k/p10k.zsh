...
#https://www.thbe.org/posts/2020/01/01/Enhance_your_macOS_terminal_p10k.html
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=6 #242
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=6 #76
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=66 #180  SGS
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=6 #37
...
#view raw
#.p10k.zsh hosted with ❤ by GitHub 
